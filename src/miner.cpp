...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("EldoradoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("EldoradoMiner : ProcessBlock, block not accepted");
    }
...
{
    LogPrintf("EldoradoMiner started\n");
    ...
    try { while (true) {
        ...
        LogPrintf("Running EldoradoMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("EldoradoMiner terminated\n");
        throw;
    }
}
