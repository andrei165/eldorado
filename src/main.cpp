...
#if defined(NDEBUG)
# error "Eldorado cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Eldorado Signed Message:\n";
...
{
    int64_t nSubsidy = (nHeight == 1 ? 2500000 : 0.00001) * COIN;
    ...
    // Subsidy is cut in half every 50,000 blocks which will occur approximately every 5 months.
    nSubsidy >>= halvings;

    return nSubsidy + nFees;
}

static const int64_t nTargetTimespan = 5 * 60 * 60; // 5 hours
